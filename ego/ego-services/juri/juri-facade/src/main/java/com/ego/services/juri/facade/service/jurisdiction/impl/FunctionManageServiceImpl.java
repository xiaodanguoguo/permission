...
import com.ego.services.juri.facade.service.jurisdiction.FunctionManageService;
    ...
    public FunctionManageVO keepFunctionManage(FunctionManageVO jsonRequest) {
        ...
        if(SysPramType.DELETE.getMsg().equals(opt)){
            ...
            if (StringUtils.isEmpty(reqBody.getParentApplicationId())) {
                ...
                if(StringUtils.isEmpty(reqBody.getFunctionCode())){
            ...
            //添加
            reqBody.setIsDelete(IsDelete.NO.getCode());
