...
public class SysInfoVO implements Serializable {
    ...
    private List<FunctionManageVO> functionManages;
    ...
    public List<FunctionManageVO> getFunctionManages() {
        return functionManages;
    }

    public void setFunctionManages(List<FunctionManageVO> functionManages) {
