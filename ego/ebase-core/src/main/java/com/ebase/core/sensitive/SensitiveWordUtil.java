 ...
 * @Project：test
 * @version 1.0
 * @Resource: http://blog.csdn.net/chenssy/article/details/26961957
 * @Ref:      http://www.iteye.com/topic/336577
 */
@SuppressWarnings("rawtypes")
public class SensitiveWordUtil {

	private volatile static SensitiveWordUtil util = null;
