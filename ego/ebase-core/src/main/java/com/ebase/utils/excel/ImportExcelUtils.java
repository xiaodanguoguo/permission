...
public class ImportExcelUtils {
	...
	/**
	 * 功能: Excel数据导入到数据库 参数: excelPath[Excel表的所在路径] 参数: startRow[从第几行开始] 参数:
	 *  参数: clazz[要返回的对象集合的类型]
	 */
	public static <T> List<T> importExcel(String originUrl, int startRow, Class<T> clazz)
			throws IOException {
		// 是否打印提示信息
	 ...
	 * 功能: Excel数据导入到数据库 参数: excelPath[Excel表的所在路径] 参数: startRow[从第几行开始] 参数:
	 *  参数: clazz[要返回的对象集合的类型]
	 *  参数 : params [beanFieldName，beanFieldName]，每列数据对应对象field
	 */
	public static <T> List<T> importExcel(String originUrl, int startRow, Class<T> clazz,String[] params)
			throws IOException {
		// 是否打印提示信息
		boolean showInfo = false;
	 ...
	 * 功能:真正实现导入
	 */
	private static <T> List<T> doImportExcel(String excelPath, int startRow,boolean showInfo,
	 ...
	 * 功能:真正实现导入(文件)
	 */
	public static <T> List<T> doImportExcelFile(File file, int startRow, boolean showInfo,
												Class<T> clazz, String[] params) throws IOException {
		Workbook wb = null;
		FileInputStream is =null;
		List<Row> rowList = new ArrayList<Row>();
	 ...
	 * 功能:返回指定的对象集合
	 */
	private static <T> List<T> returnObjectList(List<Row> rowList, Class<T> clazz,String[] params) {
		List<T> list = null;
		T t = null;
		try {
